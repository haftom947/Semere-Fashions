...
class AddEditMaintenanceLogScreen extends StatefulWidget {
  ...
  @override
  _AddEditMaintenanceLogScreenState createState() =>
      _AddEditMaintenanceLogScreenState();
}

class _AddEditMaintenanceLogScreenState
    extends State<AddEditMaintenanceLogScreen> {
  ...
  void initState() {
    ...
    if (widget.logData != null) {
      ...
      if (widget.logData!['nextDue'] != null) {
        _nextDueDate = DateTime.fromMillisecondsSinceEpoch(
          widget.logData!['nextDue'],
        );
      }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          widget.logData == null ? 'Add Maintenance' : 'Edit Maintenance',
        ),
