...
class _CommissionsScreenState extends State<CommissionsScreen> {
  ...
  Future<void> _loadCommissions() async {
    ...
    commissions.sort((a, b) => (b['createdAt'] as int).compareTo(a['createdAt'] as int));
    setState(() {
  ...
  Future<void> _markAsPaid(String commissionId) async {
    ...
    if (confirm == true) {
      ...
      commission['paidAt'] = DateTime.now().millisecondsSinceEpoch;
      await _dbHelper.update('commissions', commission);
      _loadCommissions();
    }
  }
        ...
        child: RefreshIndicator(
          ...
          child: _isLoading
              ...
              : _uiCommissions.isEmpty
                  ? const Center(
                      child: Text('No commissions found.', style: TextStyle(color: AppColors.white)),
                    )
                  : ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        DateTime createdAt = DateTime.fromMillisecondsSinceEpoch(comm['createdAt']);
