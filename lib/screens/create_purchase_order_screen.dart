...
class _CreatePurchaseOrderScreenState extends State<CreatePurchaseOrderScreen> {
  ...
  // For selecting item type (product/material)
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      Map<String, dynamic> poData = {
        ...
        'status': 'ordered', // draft could be added later
        ...
        child: _isLoading
            ...
            : Form(
                ...
                child: ListView(
                  ...
                  children: [
                    // Supplier selector (we need a SupplierSelector widget)
                    // For now, use a simple button to pick supplier. We'll create SupplierSelector later.
                    SupplierSelector(
