...
class _TenantListScreenState extends State<TenantListScreen> {
  ...
  Future<void> _loadTenants() async {
    ...
    var allTenants = List<Map<String, dynamic>>.from(
      await _dbHelper.query('tenants'),
    );
    var filtered = allTenants
        .where((t) => t['propertyId'] == widget.propertyId)
        .toList();
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      AddEditTenantScreen(propertyId: widget.propertyId),
                ),
              ).then((_) => _loadTenants());
            },
          ),
