...
class AppColors {
  ...
  static const Color backgroundStart = Color.fromARGB(255, 199, 9, 5); // Dark red
  static const Color backgroundEnd = Color.fromARGB(255, 199, 9, 5); // Even darker red
  
  // Card Background - white for cards floating on dark background
  static const Color cardBackground = Color(0xFFFFFFFF); // white
  static const Color cardBackgroundLight = Color(0xFFF5F5F5); // light grey for contrast
